...
parallel-ssh -t 0 -h experiment/config/ollama_test/ollama_hosts "cd univSchedule && pip install -r requirements.txt"
parallel-ssh -t 0 -h experiment/config/ollama_test/ollama_hosts "cd univSchedule && git reset --hard HEAD~2 && git pull"
